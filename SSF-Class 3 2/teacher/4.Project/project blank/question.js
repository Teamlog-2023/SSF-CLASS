...
function updateWeaponInfo() {
  ...
  document.getElementById('moneyValue').textContent = `${money} 원`; // 화면에 소지금 표시
  document.getElementById('sellCost').textContent = `${weapon.sellcost} 원`; // 화면에 판매 가격 표시
  document.getElementById('enhanceCost').textContent = `${weapon.enhanceCost} 원`; // 화면에 강화 가격 표시
